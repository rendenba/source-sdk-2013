#if !defined( HUD_TEAMSCORE_H )
#define HUD_TEAMSCORE_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CHudTeamScore : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHudTeamScore, vgui::Panel );

public:
	CHudTeamScore( const char *pElementName );
