...
CLIENTEFFECT_REGISTER_BEGIN( PrecacheEffectHarpoon )
...
class C_HarpoonBolt : public C_BaseCombatCharacter
{
	DECLARE_CLASS( C_HarpoonBolt, C_BaseCombatCharacter );
	DECLARE_CLIENTCLASS();
public:
...
private:
	...
	C_HarpoonBolt( const C_HarpoonBolt & ); // not defined, not accessible

	Vector	m_vecLastOrigin;
	bool	m_bUpdated;
};

IMPLEMENT_CLIENTCLASS_DT( C_HarpoonBolt, DT_HarpoonBolt, CHarpoonBolt )
END_RECV_TABLE()

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
C_HarpoonBolt::C_HarpoonBolt( void )
{
}
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_HarpoonBolt::OnDataChanged( DataUpdateType_t updateType )
{
...
// Output : int
//-----------------------------------------------------------------------------
int C_HarpoonBolt::DrawModel( int flags )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_HarpoonBolt::ClientThink( void )
{
	m_bUpdated = false;
}
...
// Input  : &data - 
//-----------------------------------------------------------------------------
void HarpoonCrosshairLoadCallback( const CEffectData &data )
{
...
DECLARE_CLIENT_EFFECT( "HarpoonLoad", HarpoonCrosshairLoadCallback );
