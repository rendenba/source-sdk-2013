...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CClassMenu2::CClassMenu2(IViewPort *pViewPort) : Frame(NULL, PANEL_CLASS2)
{
	...
	LoadControlSettings( "Resource/UI/ClassMenu2.res" );
	//m_pPanel = new RichText( this, "SClassInfo" );
	m_pPanel = dynamic_cast<RichText *>(FindChildByName("VClassInfo"));
...
void CClassMenu2::PerformLayout()
{
	int w,h;
	GetHudSize(w, h);
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CClassMenu2::CClassMenu2(IViewPort *pViewPort, const char *panelName) : Frame(NULL, panelName)
{
	m_pViewPort = pViewPort;
	m_iScoreBoardKey = BUTTON_CODE_INVALID; // this is looked up in Activate()
	m_iTeam = 0;
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CClassMenu2::~CClassMenu2()
{
}

MouseOverPanelButton* CClassMenu2::CreateNewMouseOverPanelButton(RichText *panel)
{ 
	return new MouseOverPanelButton(this, "MouseOverPanelButton", panel);
}


Panel *CClassMenu2::CreateControlByName(const char *controlName)
{
...
//-----------------------------------------------------------------------------
void CClassMenu2::OnCommand( const char *command )
{
...
//-----------------------------------------------------------------------------
void CClassMenu2::ShowPanel(bool bShow)
{
	if ( bShow )
	{
		Activate();
...
void CClassMenu2::SetData(KeyValues *data)
{
...
//-----------------------------------------------------------------------------
void CClassMenu2::SetLabelText(const char *textEntryName, const char *text)
{
...
//-----------------------------------------------------------------------------
void CClassMenu2::SetVisibleButton(const char *textEntryName, bool state)
{
...
void CClassMenu2::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
