...
FORCEINCLUDES= 
ifeq "$(CFG)" "debug"
DEFINES += -DVPC -DRAD_TELEMETRY_DISABLED -DDEBUG -D_DEBUG -DGNUC -DPOSIX -DCOMPILER_GCC -D_DLL_EXT=.so -D_LINUX -DLINUX -DPOSIX -D_POSIX -DDLLNAME=client -DBINK_VIDEO -DGL_GLEXT_PROTOTYPES -DDX_TO_GL_ABSTRACTION -DUSE_SDL -DDEV_BUILD -DFRAME_POINTER_OMISSION_DISABLED -DNO_STRING_T -DCLIENT_DLL -DVECTOR -DVERSION_SAFE_STEAM_API_INTERFACES -DPROTECTED_THINGS_ENABLE -Dstrncpy=use_Q_strncpy_instead -D_snprintf=use_Q_snprintf_instead -DUSE_WEBM_FOR_REPLAY -DHL2MP -DHL2_CLIENT_DLL -DGLOWS_ENABLE -D_EXTERNAL_DLL_EXT=.so -DVPCGAMECAPS=HL2MP -DPROJECTDIR=/home/bbartelt/COVEN/source-sdk-2013/mp/src/game/client -D_DLL_EXT=.so -DSOURCE1=1 -DVPCGAME=hl2mp -D_LINUX=1 -D_POSIX=1 -DLINUX=1 -DPOSIX=1 
else
...
CPPFILES= \
    ...
    ../../game/shared/hl2mp/weapon_doubleshotgun.cpp \
    ...
    ../../game/shared/coven_parse.cpp \
    ../../game/shared/covenlib.cpp \
    ...
    hl2mp/ui/hl2mpclientminimap.cpp \
    hl2mp/ui/hl2mpclientscoreboard.cpp \
    hl2mp/ui/hl2mptextwindow.cpp \
    hl2mp/ui/hl2mpwheelmenu.cpp \
    hl2mp/ui/hl2mpclientitemmenu.cpp \
    hl2mp/ui/hl2mpclientgrenademenu.cpp \
    hltvcamera.cpp \
    hud.cpp \
...
$(OBJ_DIR)/weapon_doubleshotgun.o : $(PWD)/../../game/shared/hl2mp/weapon_doubleshotgun.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/weapon_stake.o : $(PWD)/../../game/shared/hl2mp/weapon_stake.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/coven_parse.o : $(PWD)/../../game/shared/coven_parse.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/covenlib.o : $(PWD)/../../game/shared/covenlib.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/cloakproxy.o : $(PWD)/cloakproxy.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/c_covenbuilderlocaldata.o : $(PWD)/c_covenbuilderlocaldata.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/classmenu2.o : $(PWD)/game_controls/classmenu2.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/levelmenu.o : $(PWD)/game_controls/levelmenu.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/c_prop_soul.o : $(PWD)/hl2/c_prop_soul.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hud_abil.o : $(PWD)/hl2/hud_abil.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hud_auras.o : $(PWD)/hl2/hud_auras.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hud_healthbar.o : $(PWD)/hl2/hud_healthbar.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hud_teamscore.o : $(PWD)/hl2/hud_teamscore.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hud_xp.o : $(PWD)/hl2/hud_xp.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mpclientminimap.o : $(PWD)/hl2mp/ui/hl2mpclientminimap.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/hl2mpwheelmenu.o : $(PWD)/hl2mp/ui/hl2mpwheelmenu.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/hl2mpclientitemmenu.o : $(PWD)/hl2mp/ui/hl2mpclientitemmenu.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/hl2mpclientgrenademenu.o : $(PWD)/hl2mp/ui/hl2mpclientgrenademenu.cpp $(PWD)/client_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
