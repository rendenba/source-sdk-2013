...
BEGIN_SEND_TABLE_NOBASE( CHL2PlayerLocalData, DT_HL2Local )
	...
	SendPropInt( SENDINFO(covenCurrentLoadout1), 4, SPROP_UNSIGNED ),
	SendPropInt( SENDINFO(covenCurrentLoadout2),  4, SPROP_UNSIGNED ),
	SendPropInt( SENDINFO(covenCurrentLoadout3),  4, SPROP_UNSIGNED ),
