...
CPPFILES= \
    ...
    hl2/coven_ammocrate.cpp \
    hl2/covenbuilding.cpp \
    hl2/coven_supplydepot.cpp \
    hl2/purchaseitem.cpp \
...
$(OBJ_DIR)/weapon_doubleshotgun.o : $(PWD)/../../game/shared/hl2mp/weapon_doubleshotgun.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/weapon_stake.o : $(PWD)/../../game/shared/hl2mp/weapon_stake.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/weapon_holywater.o : $(PWD)/../../game/shared/hl2mp/weapon_holywater.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/coven_parse.o : $(PWD)/../../game/shared/coven_parse.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/covenlib.o : $(PWD)/../../game/shared/covenlib.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/covenbuilderlocaldata.o : $(PWD)/covenbuilderlocaldata.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/coven_apc.o : $(PWD)/coven_apc.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/coven_turret.o : $(PWD)/coven_turret.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/grenade_hh.o : $(PWD)/hl2/grenade_hh.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/prop_soul.o : $(PWD)/hl2/prop_soul.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
...
$(OBJ_DIR)/coven_ammocrate.o : $(PWD)/hl2/coven_ammocrate.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/covenbuilding.o : $(PWD)/hl2/covenbuilding.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/coven_supplydepot.o : $(PWD)/hl2/coven_supplydepot.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)

$(OBJ_DIR)/purchaseitem.o : $(PWD)/hl2/purchaseitem.cpp $(PWD)/server_linux32_hl2mp.mak $(SRCROOT)/devtools/makefile_base_posix.mak
	$(PRE_COMPILE_FILE)
	$(COMPILE_FILE) $(POST_COMPILE_FILE)
