...
ConVar fraglimit( "mp_fraglimit","1600", FCVAR_NOTIFY|FCVAR_REPLICATED|FCVAR_ARCHIVE, "The number of kills at which the map ends");
...
//=============================================================================
	...
	{
		//BB: only progressive damage for us
