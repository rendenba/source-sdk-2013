...
#define COVEN_XP_INCREASE_PER_LEVEL 32
...
#define COVEN_CLASSID_DEADEYE 4

#define COVEN_MAX_CLASSCOUNT 3
#define COVEN_CLASSCOUNT_SLAYERS 3
#define COVEN_CLASSCOUNT_VAMPIRES 2
