...
//BB: CovenDefs
#define COVEN_MAX_XP_PER_LEVEL 18//128
#define COVEN_HP_PER_STRENGTH 8

//#define COVEN_DPS_PER_AGIL 1

#define COVEN_MELEE_STR_MULT 1
#define COVEN_MELEE_AGIL_MULT 2
