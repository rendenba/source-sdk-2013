...
<<<<<<< HEAD:mp/src/game/server/hl2/hl2_playerlocaldata.cpp
	SendPropFloat( SENDINFO(m_flSuitPower), 11, SPROP_UNSIGNED | SPROP_ROUNDUP | SPROP_CHANGES_OFTEN, 0.0, 400.0 ),
=======
...
>>>>>>> upstream/master:src/game/server/hl2/hl2_playerlocaldata.cpp
	...
	SendPropInt( SENDINFO(covenXPCounter), 12, SPROP_UNSIGNED ),
	...
	SendPropArray3( SENDINFO_ARRAY3(covenStatusMagnitude), SendPropInt( SENDINFO_ARRAY(covenStatusMagnitude), 8, SPROP_UNSIGNED | SPROP_CHANGES_OFTEN ) ),
