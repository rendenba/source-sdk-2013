...
BEGIN_SEND_TABLE_NOBASE( CPlayerLocalData, DT_Local )
	...
	SendPropInt		(SENDINFO(m_bInDodge), 1, SPROP_UNSIGNED ),
	SendPropFloat	(SENDINFO(m_flDodgetime), 10, SPROP_ROUNDDOWN, 0.0f, 512.0f ),
	SendPropFloat	(SENDINFO(m_flStamina), 10, SPROP_ROUNDUP, 0.0f, 256.0f ),
