...
<<<<<<< HEAD:mp/src/game/shared/shareddefs.h
...
>>>>>>> upstream/master:src/game/shared/shareddefs.h
...
typedef enum
{
	...
	GLOW_OUTLINE_OPPOSING_TEAM_ONLY,
	GLOW_OUTLINE_USE_TEAM_COLORS,
	GLOW_OUTLINE_USE_PROP_WIDTH,
...
typedef enum
{
	...
	BUILDING_PURCHASE_SLAM,
	BUILDING_TYPE_COUNT
} BuildingType_t;

struct CovenBuyZone_s
{
	Vector low;
	Vector high;
};
...
typedef enum
{
	...
	COVEN_STATUS_DASH,
	COVEN_STATUS_EXHAUSTION,
	COVEN_STATUS_TERRIFIED,
	COVEN_STATUS_HOLYSICK,
	COVEN_STATUS_COUNT
} CovenStatus_t;
